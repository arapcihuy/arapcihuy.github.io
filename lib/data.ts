...
export const educationData = [
  {
    ...
    grade: "Grade A",
    description: "Participated in the Bangkit Academy program, focusing on Cloud Computing.",
    delay: "0s",
    type: "Certification",
  },
  {
    ...
    description: "Foundational security concepts and practices.",
    delay: "0.05s",
    type: "Certification",
  ...
  },
  {
    ...
    description: "Graduated with a focus on web technologies and user interface design.",
    delay: "0.1s",
    type: "University",
  },
]
